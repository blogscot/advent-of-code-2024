...
fn solve(a: Matrix2<f64>, b: Vector2<f64>) -> Option<Vector2<f64>> {
    let decomp = a.lu();
    decomp.solve(&b)
}
...
fn solve_part1(data : Vec<&str>, offset : u64) -> u64 {
...
fn main() {
    ...
    println!("Part 1: {}", solve_part1(data.clone(), 0));
    println!("Part 1: {}", solve_part1(data.clone(), 10000000000000));
}
